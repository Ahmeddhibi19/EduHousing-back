...
public interface AdminApi {
    ...
    @GetMapping(value = APP_ROOT+"/admin/authorized/find_by_id/{adminId}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT+"/admin/authorized/find_by_email/{email}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT+"/admin/authorized/find_by_phone_number/{phone_number}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT+"/admin/authorized/find_by_firrst_name/{first_name}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT+"/admin/authorized/all",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = APP_ROOT+"/admin/authorized/update",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping (value = APP_ROOT+"/admin/authorized/delete_by_id/{id}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping (value = APP_ROOT+"/admin/authorized/delete_by_phone_number/{phone_number}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping (value = APP_ROOT+"/admin/authorized/delete_by_email/{email}",produces = MediaType.APPLICATION_JSON_VALUE)
