...
public interface RequestApi {
    @PostMapping(value = APP_ROOT+"/request/student/create/{student_id}/{rentalDetails_id}",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT+"/request/student/student_rentalDetails/{student_id}/{rentalDetails_id}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT+"/request/admin_homeowner/rentalDetails/{rentalDetails_id}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT+"/request/admin_homeowner/validated_rentalDetails/{rentalDetails_id}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT+"/request/admin_student/validated_student/{student_id}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = APP_ROOT+"/request/student/update",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = APP_ROOT+"/request/student/delete_by_id/{id}",produces = MediaType.APPLICATION_JSON_VALUE)
