...
public interface FavouritesApi {
    @PostMapping(value = APP_ROOT+"/favourites/create/{student_id}/{apartment_id}",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = APP_ROOT+"/favourites/delete_by_id/{id}",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT+"/favourites/{student_id}",produces = MediaType.APPLICATION_JSON_VALUE)
